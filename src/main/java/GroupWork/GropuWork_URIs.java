...
public class GropuWork_URIs {
	...
	public static void main(String[] args) {
		...
		ArrayList <String> uriList = new ArrayList <String>(Arrays.asList ( "country/Namibia","country/Rasnska","country/Ruotsi", "country/Suomi",
				"Göteborg","Helsinki", "Espoo", "Oulu", "Rundu", "Vantaa"));

		for (String uri : uriList) {
		driver.get("localhost:8080/apartments/"+uri);
		text = driver.findElement(By.xpath("/html/body/pre"));
		dataText = text.getText();
		System.out.println("localhost:8080/apartments/" +uri+ " has " + amount.countFreq("streetAddress", dataText)
				+ " apartments.");
		}
